...
type ShippingMethod = "free" | "flat" | "local";
type PaymentMethod = "paypal" | "debit" | "bank" | "check" | "cod";
...
const mockOrderItems: OrderItem[] = [
  { id: "1", name: "Dolore magna aliquam", qty: 1, price: 15.0 },
];

const FLAT_RATE = 3.99;
const LOCAL_PICKUP = 12.0;
...
const CheckoutPage = () => {
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-330 py-10 sm:py-14">
        <div className="mb-4 flex items-center gap-2 rounded border border-[#f5d9c0] bg-[#fef6ef] px-4 py-3 text-sm text-gray-700">
        ...
        {couponVisible && (
          <div className="mb-6 flex items-center gap-3 rounded border border-gray-200 bg-white px-4 py-4 shadow-sm">
            <input
              type="text"
