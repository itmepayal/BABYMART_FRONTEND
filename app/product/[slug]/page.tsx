      ...
      <div className="mx-auto max-w-330 px-4 py-10 sm:py-14">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-2">
              {[
                ...
                <div
                  key={unit.label}
                  className="flex flex-col items-center rounded-lg bg-main px-3 py-2 text-white min-w-13"
                >
            ...
            <div className="rounded-xl border-2 border-dashed border-main/30 bg-main/5 p-4">
        ...
        <div className="mt-14">
          ...
          {activeTab === "description" && (
            <div className="mt-8 flex flex-col gap-6 text-base leading-relaxed text-(--body_typo-color)">
              <p>
          ...
          {activeTab === "additionalInfo" && (
            <div className="mt-8">
              <table className="w-full border-collapse text-sm text-(--body_typo-color)">
                <tbody>
                  {additionalInfoRows.map((row, i) => (
                    ...
                    >
                      <td className="border border-border px-4 py-3 font-semibold text-(--title_typo-color) w-40">
                        {row.label}
                      </td>
            ...
            <div className="mt-8 flex flex-col gap-8">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center gap-2 rounded-full bg-coral px-6 py-2.5 text-sm font-bold tracking-wide text-white transition-opacity hover:opacity-90"
                >
                  <Pencil size={14} />
                  WRITE A REVIEW
                </button>
              ...
              {showReviewForm && (
                <div className="flex flex-col gap-5">
                  <h3 className="text-base font-bold text-(--title_typo-color)">
                  ...
                  <label className="flex items-center gap-2 text-sm text-(--body_typo-color) cursor-pointer">
                    <input
                      type="checkbox"
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-sm text-(--body_typo-color)">
                      Your rating *
                    </label>
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                      ...
                      className="w-full rounded-lg border border-border bg-gray-50 px-4 py-3 text-sm text-(--title_typo-color) focus:border-main focus:outline-none resize-y"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <input
                        ...
                        className="w-full rounded-lg border border-border bg-gray-50 px-4 py-3 text-sm text-(--title_typo-color) focus:border-main focus:outline-none"
                      />
                    </div>
                    <div className="flex flex-col gap-1.5">
                      <label className="text-sm text-(--body_typo-color)">
                  ...
                  <button
                    type="button"
                    className="self-start rounded border border-border px-6 py-2.5 text-sm font-bold tracking-wide text-(--title_typo-color) transition-colors hover:border-main hover:text-main"
                  >
                    SUBMIT
                  </button>
                </div>
        ...
        <div className="mt-14">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
            {relatedProducts.map((p) => (
              ...
              >
                <div className="relative aspect-square w-full overflow-hidden rounded-lg bg-main-mix-bg/30">
                  <Image
                    src={p.image}
                    alt={p.title}
                    fill
